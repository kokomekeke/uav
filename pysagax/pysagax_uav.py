...
class Commander:
    ...
    def __init__(
        ...
        self._stream_packets_q = self._manager.Queue(maxsize=200)
        ...
        self._post_proc_to_scan_engine_q = self._manager.Queue(maxsize=200)
        self._pp_heading_sync_input_q = self._manager.Queue(maxsize=200)
        self._pp_spectrogram_recorder_input_q = self._manager.Queue(maxsize=200)
        self._pp_detection_input_q = self._manager.Queue(maxsize=200)
        self._pp_events_input_q = self._manager.Queue(maxsize=200)
        self._pp_streamprep_input_q = self._manager.Queue(maxsize=200)
        ...
        self._heading_data_q = self._manager.Queue(maxsize=200)
