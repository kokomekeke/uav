...
class TargetMocker(multiprocessing.Process):
    def __init__(self, commander1_q, commander2_q, lat, lon, heading, speed, rx1_lat, rx1_lon, rx2_lat, rx2_lon):
    ...
    def generate_new_config(self):
        ...
        sm1 = self.make_simulated_measurement(lat1, lon1, azim1, azim1)
        sm2 = self.make_simulated_measurement(lat2, lon2, azim2, azim2)
        
        self.commander1_q.put(sm1)
        self.commander2_q.put(sm2)

    def make_simulated_measurement(self, lat, lon, azimuth, mean_azimuth):
        ...
        sm = SimulatedMeasurement(
            ...
            detections=[
                SimulatedDetection(
                    ...
                    azimuth=(azimuth,deg2rad(0), 0),
                    # mean_azimuth=(mean_azimuth,deg2rad(1),deg2rad(3)),
                    mean_azimuth=(mean_azimuth,deg2rad(0), 0),
                    elevation=None,
                    mean_elevation=None,
                    deviation=None,
                ),
...
def main(level: str, show_gui: bool = False, port: int = 5556,
         lat=0, lon=0, heading=0, speed=1, rx1_lat=0, rx1_lon=0, rx2_lat=0, rx2_lon=0):
    """
    TODO
    ...
    target_mocker = TargetMocker(
        ...
        , rx1_lat=rx1_lat, rx1_lon=rx1_lon, rx2_lat=rx2_lat, rx2_lon=rx2_lon
        )
