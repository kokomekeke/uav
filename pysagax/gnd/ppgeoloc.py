...
class PPGeoLoc(Loop):
    ...
    def _triangulate(self, d1: ComIntDetectionEntity, d2: ComIntDetectionEntity):
        ...
        def triangulate_nautipy(lat1, lon1, azim1, lat2, lon2, azim2, lat_gt=.0, lon_gt=.0):
            ...
            print(f" a1={azim1:.2f}, a1'={azim1_back:.2f}, a2={azim2:.2f}, a2'={azim2_back:.2f} >>> f{abs(normalize_angle(azim1_back - azim1, 180, -180))>5} {abs(normalize_angle(azim2_back - azim2, 180, -180))>5}", )
            if abs(normalize_angle(azim1_back - azim1, 180, -180))>5 or abs(normalize_angle(azim2_back - azim2, 180, -180))>5:
                print(f"NO INTERSECITÁON a1={azim1:2f}, a1'={azim1_back}, a2={azim2:2f}, a2'={azim2_back:2f}", )
    ...
    def _loop(self) -> None:
        ...
        print("GEOLOC time", time.time()-start_time)
