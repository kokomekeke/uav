...
class ROIMask(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["center_frequency", b"center_frequency", "roi_id", b"roi_id", "span", b"span", "threshold", b"threshold"]) -> None: ...
...
class FreqList(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["center_freqs", b"center_freqs", "iq_rate", b"iq_rate"]) -> None: ...
...
class PostProcessingConfig(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["mean_window", b"mean_window", "roi", b"roi"]) -> None: ...
...
class Config(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["cs", b"cs", "heading", b"heading", "pp", b"pp", "se", b"se"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["config_id", b"config_id", "cs", b"cs", "heading", b"heading", "pp", b"pp", "se", b"se"]) -> None: ...
...
class ScanEngineConfig(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["parameter", b"parameter", "scanning", b"scanning", "tracking", b"tracking"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["mode", b"mode", "parameter", b"parameter", "scanning", b"scanning", "tracking", b"tracking"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["parameter", b"parameter"]) -> typing.Literal["scanning", "tracking"] | None: ...
...
class TrackedSignal(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["bandwidth", b"bandwidth", "frequency", b"frequency"]) -> None: ...
...
class TrackingConfig(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["signals", b"signals"]) -> None: ...
...
class SystemInfo(google.protobuf.message.Message):
    ...
    class Hardware(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["disk", b"disk", "hostname", b"hostname"]) -> None: ...
    ...
    class Software(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["cs_version", b"cs_version", "pysagax_version", b"pysagax_version"]) -> None: ...
    ...
    def HasField(self, field_name: typing.Literal["hardware", b"hardware", "heading", b"heading", "software", b"software"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["hardware", b"hardware", "heading", b"heading", "radios", b"radios", "software", b"software"]) -> None: ...
...
class StreamTarget(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["address", b"address", "heartbeat_timeout", b"heartbeat_timeout", "id", b"id", "level", b"level", "port", b"port", "telemetry_timeout", b"telemetry_timeout"]) -> None: ...
...
class CommandError(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["description", b"description", "time", b"time", "type", b"type"]) -> None: ...
...
class Command(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["calibration_freqs", b"calibration_freqs", "config", b"config", "parameter", b"parameter", "ping_data", b"ping_data", "position", b"position", "rec_length_secs", b"rec_length_secs", "target", b"target"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["calibration_freqs", b"calibration_freqs", "config", b"config", "id", b"id", "instruction", b"instruction", "kind", b"kind", "parameter", b"parameter", "ping_data", b"ping_data", "position", b"position", "rec_length_secs", b"rec_length_secs", "target", b"target"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["parameter", b"parameter"]) -> typing.Literal["ping_data", "config", "position", "target", "rec_length_secs", "calibration_freqs"] | None: ...
...
class ConfigStatus(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["error_code", b"error_code", "error_description", b"error_description", "finish_time", b"finish_time", "queue", b"queue", "responses", b"responses", "start_time", b"start_time", "success", b"success"]) -> None: ...
...
class Response(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["config", b"config", "config_status", b"config_status", "data", b"data", "error", b"error", "info", b"info", "ping_data", b"ping_data", "position", b"position", "success", b"success", "telemetry", b"telemetry"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["config", b"config", "config_status", b"config_status", "data", b"data", "error", b"error", "id", b"id", "info", b"info", "instruction", b"instruction", "ping_data", b"ping_data", "position", b"position", "success", b"success", "telemetry", b"telemetry"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["data", b"data"]) -> typing.Literal["success", "ping_data", "config", "telemetry", "info", "position", "config_status"] | None: ...
