...
class HeadingStatus(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["available_source_types", b"available_source_types", "calibration_status", b"calibration_status", "parameters", b"parameters", "selected_source_type", b"selected_source_type", "status", b"status"]) -> None: ...
...
class HeadingConfig(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["parameters", b"parameters", "selected_source_type", b"selected_source_type"]) -> None: ...
